...
export const DICTIONARY: Dictionary = {
  id: {
    ...
    legalityDoc: {
      ...
      footerNote: 'NIB ini berlaku di seluruh wilayah Republik Indonesia selama menjalankan kegiatan usaha dan berlaku sebagai hak akses kepabeanan, pendaftaran kepesertaan jaminan sosial kesehatan dan ketenagakerjaan, serta bukti pemenuhan laporan pertama Wajib Lapor Ketenagakerjaan di Perusahaan (WLKP).',
      datePlace: 'Diterbitkan di Jakarta, tanggal: 25 November 2025',
    ...
    footer: {
      ...
      copyright: '© 2016 - 2025 Guccio Gucci S.p.A. - All rights reserved.',
      links: [],
      legal: []
    }
  },
